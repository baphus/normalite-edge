...
| Document | Purpose |
|---|---|
| **[contract/CONTRACT_OF_SERVICE_v1.2.0.md](contract/CONTRACT_OF_SERVICE_v1.2.0.md)** | **The operative instrument.** Parties, scope, period, price, deliverables, payment, nature of engagement, confidentiality and data protection, intellectual property, turnover, warranty, termination, compliance. The four documents below are its Annexes "A"–"D", incorporated at Section 12.7. |
| [contract/CONTRACT_DRAFTING_NOTES_v1.0.2.md](contract/CONTRACT_DRAFTING_NOTES_v1.0.2.md) | **Internal — not for transmittal.** Fill-in checklist, matters to settle with Accounting, Legal and the BAC before signature, departures from the supplied template, and clauses flagged for legal review |
| [contract/PROPOSAL_AND_SOW_v1.2.0.md](contract/PROPOSAL_AND_SOW_v1.2.0.md) | *Annex "A".* Proposal, scope of work, ₱30,000 allocation, payment terms, acceptance, exclusions, IP and handover, standards-readiness |
...
| `CONTRACT_OF_SERVICE_v1.0.0.md` | `CONTRACT_OF_SERVICE_v1.2.0.md` | Contractor named by placeholder; parties clause incomplete |
| `CONTRACT_DRAFTING_NOTES_v1.0.0.md` | `CONTRACT_DRAFTING_NOTES_v1.0.2.md` | Posed the legal-name question as open; now resolved |
...
| `PACKAGE_CONTENTS_v1.0.0.md`, `PACKAGE_CONTENTS_v1.1.0.md` | `PACKAGE_CONTENTS_v1.3.0.md` | Predate the Contract-plus-Annexes structure and the full legal name |
