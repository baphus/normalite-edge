...
| Document | Purpose |
|---|---|
| [contract/PROPOSAL_AND_SOW_v1.0.0.md](contract/PROPOSAL_AND_SOW_v1.0.0.md) | Proposal, scope of work, ₱30,000 allocation, payment terms, acceptance, exclusions, IP and handover, standards-readiness |
| [contract/DELIVERABLES_REGISTER_v1.0.0.md](contract/DELIVERABLES_REGISTER_v1.0.0.md) | Itemised deliverables (D1–D30, F1.1–F11.11) with acceptance evidence and sign-off |
| [contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.0.md](contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.0.md) | Two-month defect warranty: defect vs. feature, severity targets, reporting, exclusions, end-of-period options |
| [contract/ADMIN_ORIENTATION_PLAN_v1.0.0.md](contract/ADMIN_ORIENTATION_PLAN_v1.0.0.md) | Three-session administrator orientation with attendance and competence records |

### 1.2 System documentation

| Document | Purpose |
|---|---|
| [system/SYSTEM_DOCUMENTATION_v1.0.0.md](system/SYSTEM_DOCUMENTATION_v1.0.0.md) | Technical baseline — architecture, auth model, security controls, data model, API surface, standards-readiness |
| [../PROJECT_SUMMARY_v2.0.0.md](../PROJECT_SUMMARY_v2.0.0.md) | Feature inventory and honest known-limitations statement |

### 1.3 User manuals

| Document | Audience |
|---|---|
| [manuals/USER_MANUAL_ADMIN_v1.0.0.md](manuals/USER_MANUAL_ADMIN_v1.0.0.md) | Administrators |
| [manuals/USER_MANUAL_REVIEWER_v1.0.0.md](manuals/USER_MANUAL_REVIEWER_v1.0.0.md) | Reviewers / instructors |
...
|---|---|---|
| `PROJECT_SUMMARY_v1.1.1.md` | [PROJECT_SUMMARY_v2.0.0.md](../PROJECT_SUMMARY_v2.0.0.md) | Describes the pre-Supabase auth model; its "Known Limitations" and security-gap sections are no longer accurate |
| `PRICING_PROPOSAL_v1.0.0.md` | [contract/PROPOSAL_AND_SOW_v1.0.0.md](contract/PROPOSAL_AND_SOW_v1.0.0.md) | Quoted an unresolved ₱25,000–₱30,000 range; omits Phase 3, support, orientation, and manuals |
...
| [system/SYSTEM_DOCUMENTATION_v1.0.0.md](system/SYSTEM_DOCUMENTATION_v1.0.0.md) §11 | ISO 27001 A.5.15, A.5.18, A.5.19–A.5.22, A.5.33, A.8.5, A.8.9, A.8.10, A.8.13, A.8.15, A.8.16, A.8.24, A.8.28; SOC 2 CC6, CC7, CC8, CC9, A1, C1; DPTM all principles |
| [contract/PROPOSAL_AND_SOW_v1.0.0.md](contract/PROPOSAL_AND_SOW_v1.0.0.md) §13 | Same, plus ISO 9001 8.3.4, 8.5.6 |
| [contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.0.md](contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.0.md) §9 | ISO 9001 8.2.3, 8.5.5, 9.1.2, 10.2; ISO 27001 A.5.24–A.5.30, A.8.32; SOC 2 CC7.3–CC7.5, CC8.1 |
| [contract/ADMIN_ORIENTATION_PLAN_v1.0.0.md](contract/ADMIN_ORIENTATION_PLAN_v1.0.0.md) §10 | ISO 9001 7.1.6, 7.2; ISO 27001 A.5.3, A.5.18, A.6.3; SOC 2 CC1.4; DPTM Governance |
...
| 6 | **Backup & Business Continuity Procedure** | ISO 27001 A.8.13; SOC 2 A1.2 | Recovery objectives (RPO/RTO); Supabase tier | Yes — plus one restore drill to prove it |
...
**None of items 1–10 are in the current contract scope** (see [contract/PROPOSAL_AND_SOW_v1.0.0.md](contract/PROPOSAL_AND_SOW_v1.0.0.md) §9, E5). They are listed here so the gap is visible and costed rather than discovered at audit time.
...
|---|---|
| [system/SYSTEM_DOCUMENTATION_v1.0.0.md](system/SYSTEM_DOCUMENTATION_v1.0.0.md) | Its standards-readiness assessment (§11) is a professional judgment, not a code fact |
| [../PROJECT_SUMMARY_v2.0.0.md](../PROJECT_SUMMARY_v2.0.0.md) | The known-limitations section requires judgment about what constitutes a limitation versus a design decision |
...
|---|---|
| [contract/PROPOSAL_AND_SOW_v1.0.0.md](contract/PROPOSAL_AND_SOW_v1.0.0.md) | Commercial terms, pricing, payment, IP transfer |
| [contract/DELIVERABLES_REGISTER_v1.0.0.md](contract/DELIVERABLES_REGISTER_v1.0.0.md) | The register is largely derivable; the **acceptance criteria and sign-off** are contractual commitments |
| [contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.0.md](contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.0.md) | Service commitments and defect/feature boundary |
| [contract/ADMIN_ORIENTATION_PLAN_v1.0.0.md](contract/ADMIN_ORIENTATION_PLAN_v1.0.0.md) | Pedagogical judgment about what people need to learn and in what order |
...
**A new versioned file is created for each revision; the previous version is never overwritten.** `PROJECT_SUMMARY_v2.0.0.md` is the worked example — the authentication rebuild invalidated so much of v1.1.1 that a MAJOR increment was the only honest classification, and v1.1.1 remains in the repository as the historical record of what was true in July 2026.
