...
**Version:** 1.4.0
**Date:** 2026-08-04
**Prepared by:** Josephus Kim L. Sarsonas
...
- **v1.4.0 (2026-08-09):** **The Contract of Service is now wholly self-contained.** It follows the client-supplied template exactly and incorporates no annexes: the system specifications, documentation list, orientation programme, price allocation, turnover platforms, and warranty response periods are written into the Contract itself. The Proposal, Deliverables Register, Maintenance and Support Terms, and Administrator Orientation Plan are accordingly **supporting documents rather than annexes**, and are no longer part of the agreement. Renumbered and relabelled throughout, and cross-references retargeted.
- **v1.3.0 (2026-08-09):** **Contract period moved to 1 August 2026 – 31 January 2027.** The engagement is now *prospective* — the window in which the system and documentation are delivered and accepted, the administrator orientation is conducted, the accounts are turned over, and the two-month warranty runs. Development itself took place earlier (February–August 2026) and is recorded as the development history of the delivered work product. **No change to scope, price, or any other term.** Superseded versions recorded.
- **v1.2.0 (2026-08-09):** Corrected the contractor's name to the full legal name, **Josephus Kim L. Sarsonas**, so that the Contract, the accomplishment report, and the Bureau of Internal Revenue documents all carry the same name. No other change. Added the Contract of Service and its drafting notes to the index, and recorded the superseded versions. Retargeted cross-references to the current document versions.
...
| Document | Purpose |
|---|---|
| **[contract/CONTRACT_OF_SERVICE_v2.0.0.md](contract/CONTRACT_OF_SERVICE_v2.0.0.md)** | **The operative instrument.** Parties, scope, period, price, deliverables, payment, nature of engagement, confidentiality and data protection, intellectual property, turnover, warranty, termination, compliance. The four documents below are its Annexes "A"–"D", incorporated at Section 12.7. |
| [contract/CONTRACT_DRAFTING_NOTES_v1.1.0.md](contract/CONTRACT_DRAFTING_NOTES_v1.1.0.md) | **Internal — not for transmittal.** Fill-in checklist, matters to settle with Accounting, Legal and the BAC before signature, departures from the supplied template, and clauses flagged for legal review |
| [contract/PROPOSAL_AND_SOW_v1.2.0.md](contract/PROPOSAL_AND_SOW_v1.2.0.md) | Proposal, scope of work, ₱30,000 allocation, payment terms, acceptance, exclusions, IP and handover, standards-readiness |
| [contract/DELIVERABLES_REGISTER_v1.1.2.md](contract/DELIVERABLES_REGISTER_v1.1.2.md) | Itemised deliverables (D1–D30, F1.1–F11.11) with acceptance evidence and sign-off |
| [contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.3.md](contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.3.md) | Two-month defect warranty: defect vs. feature, severity targets, reporting, exclusions, end-of-period options |
| [contract/ADMIN_ORIENTATION_PLAN_v1.0.3.md](contract/ADMIN_ORIENTATION_PLAN_v1.0.3.md) | Three-session administrator orientation with attendance and competence records |

### 1.2 System documentation

| Document | Purpose |
|---|---|
| [system/SYSTEM_DOCUMENTATION_v1.0.3.md](system/SYSTEM_DOCUMENTATION_v1.0.3.md) | Technical baseline — architecture, auth model, security controls, data model, API surface, standards-readiness |
| [../PROJECT_SUMMARY_v2.0.3.md](../PROJECT_SUMMARY_v2.0.3.md) | Feature inventory and honest known-limitations statement |

### 1.3 User manuals

| Document | Audience |
|---|---|
| [manuals/USER_MANUAL_ADMIN_v1.0.3.md](manuals/USER_MANUAL_ADMIN_v1.0.3.md) | Administrators |
| [manuals/USER_MANUAL_REVIEWER_v1.0.3.md](manuals/USER_MANUAL_REVIEWER_v1.0.3.md) | Reviewers / instructors |
...
|---|---|---|
| `PROJECT_SUMMARY_v1.1.1.md` | [PROJECT_SUMMARY_v2.0.3.md](../PROJECT_SUMMARY_v2.0.3.md) | Describes the pre-Supabase auth model; its "Known Limitations" and security-gap sections are no longer accurate |
| `PRICING_PROPOSAL_v1.0.0.md` | [contract/PROPOSAL_AND_SOW_v1.2.0.md](contract/PROPOSAL_AND_SOW_v1.2.0.md) | Quoted an unresolved ₱25,000–₱30,000 range; omits Phase 3, support, orientation, and manuals |
...
| `PROPOSAL_AND_SOW_v1.0.0.md` | `PROPOSAL_AND_SOW_v1.2.0.md` | Period started January (unevidenced); coarse phase pricing; hosting costs not yet ₱0; handover list omitted Vercel and the Google Cloud OAuth client |
| `DELIVERABLES_REGISTER_v1.0.0.md` | `DELIVERABLES_REGISTER_v1.1.2.md` | No cost allocation; handover list incomplete |
| `MAINTENANCE_AND_SUPPORT_TERMS_v1.0.0.md` | `MAINTENANCE_AND_SUPPORT_TERMS_v1.0.3.md` | Stale cross-references; hosting stated as a CNU-paid cost rather than ₱0 |
| `ADMIN_ORIENTATION_PLAN_v1.0.0.md` | `ADMIN_ORIENTATION_PLAN_v1.0.3.md` | Stale cross-references; no hosting/backup segment |
| `SYSTEM_DOCUMENTATION_v1.0.0.md` | `SYSTEM_DOCUMENTATION_v1.0.3.md` | Stated a 7-day Pro-tier backup window that does not apply on the free tier |
| `USER_MANUAL_ADMIN_v1.0.0.md` | `USER_MANUAL_ADMIN_v1.0.3.md` | Stale cross-references; hosting-tier guidance predated the free-tier position |
| `USER_MANUAL_REVIEWER_v1.0.0.md` | `USER_MANUAL_REVIEWER_v1.0.3.md` | Stale cross-references |
| `PROJECT_SUMMARY_v2.0.0.md` | `PROJECT_SUMMARY_v2.0.3.md` | Stated Supabase Pro-tier backups, which do not apply on the free tier; malformed table row in §7 |
| `CONTRACT_OF_SERVICE_v1.0.0.md` | `CONTRACT_OF_SERVICE_v2.0.0.md` | Contractor named by placeholder; parties clause incomplete |
| `CONTRACT_DRAFTING_NOTES_v1.0.0.md` | `CONTRACT_DRAFTING_NOTES_v1.1.0.md` | Posed the legal-name question as open; now resolved |
| `PROPOSAL_AND_SOW_v1.1.0.md` | `PROPOSAL_AND_SOW_v1.2.0.md` | Short-form contractor name |
| `DELIVERABLES_REGISTER_v1.1.0.md` | `DELIVERABLES_REGISTER_v1.1.2.md` | Short-form contractor name |
| `MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md` | `MAINTENANCE_AND_SUPPORT_TERMS_v1.0.3.md` | Short-form contractor name |
| `ADMIN_ORIENTATION_PLAN_v1.0.1.md` | `ADMIN_ORIENTATION_PLAN_v1.0.3.md` | Short-form contractor name |
| `SYSTEM_DOCUMENTATION_v1.0.1.md` | `SYSTEM_DOCUMENTATION_v1.0.3.md` | Short-form contractor name |
| `PROJECT_SUMMARY_v2.0.1.md` | `PROJECT_SUMMARY_v2.0.3.md` | Short-form contractor name |
| `USER_MANUAL_ADMIN_v1.0.1.md` | `USER_MANUAL_ADMIN_v1.0.3.md` | Stale cross-references only |
| `USER_MANUAL_REVIEWER_v1.0.1.md` | `USER_MANUAL_REVIEWER_v1.0.3.md` | Stale cross-references only |
| `PACKAGE_CONTENTS_v1.0.0.md`, `PACKAGE_CONTENTS_v1.1.0.md` | `PACKAGE_CONTENTS_v1.4.0.md` | Predate the standalone Contract and the full legal name |
| `DOCUMENTATION_INDEX_v1.0.0.md`, `DOCUMENTATION_INDEX_v1.1.0.md` | This document | Predate the Contract of Service |
...
| [system/SYSTEM_DOCUMENTATION_v1.0.3.md](system/SYSTEM_DOCUMENTATION_v1.0.3.md) §11 | ISO 27001 A.5.15, A.5.18, A.5.19–A.5.22, A.5.33, A.8.5, A.8.9, A.8.10, A.8.13, A.8.15, A.8.16, A.8.24, A.8.28; SOC 2 CC6, CC7, CC8, CC9, A1, C1; DPTM all principles |
| [contract/PROPOSAL_AND_SOW_v1.2.0.md](contract/PROPOSAL_AND_SOW_v1.2.0.md) §13 | Same, plus ISO 9001 8.3.4, 8.5.6 |
| [contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.3.md](contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.3.md) §9 | ISO 9001 8.2.3, 8.5.5, 9.1.2, 10.2; ISO 27001 A.5.24–A.5.30, A.8.32; SOC 2 CC7.3–CC7.5, CC8.1 |
| [contract/ADMIN_ORIENTATION_PLAN_v1.0.3.md](contract/ADMIN_ORIENTATION_PLAN_v1.0.3.md) §10 | ISO 9001 7.1.6, 7.2; ISO 27001 A.5.3, A.5.18, A.6.3; SOC 2 CC1.4; DPTM Governance |
...
**None of items 1–10 are in the current contract scope** (see [contract/PROPOSAL_AND_SOW_v1.2.0.md](contract/PROPOSAL_AND_SOW_v1.2.0.md) §9, E5). They are listed here so the gap is visible and costed rather than discovered at audit time.
...
|---|---|
| [system/SYSTEM_DOCUMENTATION_v1.0.3.md](system/SYSTEM_DOCUMENTATION_v1.0.3.md) | Its standards-readiness assessment (§11) is a professional judgment, not a code fact |
| [../PROJECT_SUMMARY_v2.0.3.md](../PROJECT_SUMMARY_v2.0.3.md) | The known-limitations section requires judgment about what constitutes a limitation versus a design decision |
...
|---|---|
| [contract/PROPOSAL_AND_SOW_v1.2.0.md](contract/PROPOSAL_AND_SOW_v1.2.0.md) | Commercial terms, pricing, payment, IP transfer |
| [contract/DELIVERABLES_REGISTER_v1.1.2.md](contract/DELIVERABLES_REGISTER_v1.1.2.md) | The register is largely derivable; the **acceptance criteria and sign-off** are contractual commitments |
| [contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.3.md](contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.3.md) | Service commitments and defect/feature boundary |
| [contract/ADMIN_ORIENTATION_PLAN_v1.0.3.md](contract/ADMIN_ORIENTATION_PLAN_v1.0.3.md) | Pedagogical judgment about what people need to learn and in what order |
...
**A new versioned file is created for each revision; the previous version is never overwritten.** `PROJECT_SUMMARY_v2.0.3.md` is the worked example — the authentication rebuild invalidated so much of v1.1.1 that a MAJOR increment was the only honest classification, and v1.1.1 remains in the repository as the historical record of what was true in July 2026.

---

## 5. Cross-reference version pinning — a note for future revisions

Documents in this set link to each other by **version-pinned filename** (`PROPOSAL_AND_SOW_v1.2.0.md`, not `PROPOSAL_AND_SOW.md`). Combined with the rule that every edit creates a new versioned file, this has a consequence worth knowing before the next revision:
