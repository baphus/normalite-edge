...
- v1.0.1 (2026-08-04): Retargeted cross-references to the current document versions. Added a hosting-tier item to Session 1 Part A, since hosting now runs on free tiers and the backup position is a CNU decision. **No change to the session structure, duration, or programme content.**
...
| 4 | Attendees have skimmed [USER_MANUAL_ADMIN_v1.0.1.md](../manuals/USER_MANUAL_ADMIN_v1.0.1.md) | Not required, but sessions go further if they have |
...
### Part E — Hosting, backups, and what that means for you (10 min)

Short but important, and aimed at the IT office representative in particular.

- All four platforms currently run on **free tiers — hosting costs CNU ₱0**
- **The Supabase free tier takes no automatic database backups.** Student examination records currently have no automatic backup.
- The Render free tier spins down when idle, so the first request after a quiet period is slow — which matters at the opening minute of a timed exam
- Neither is urgent today; both are CNU decisions with a cost attached, and I will advise on tier and timing whenever CNU wants to review it

**The question to take away:** could CNU tolerate losing a cohort of examination data? That, not cost, is what should drive the backup decision.

### Part F — Questions (10 min)
...
4. **Confirmation of the support channel** and how to report a defect (see [MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md](MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md) §5)
...
| Material | Form |
|---|---|
| [USER_MANUAL_ADMIN_v1.0.1.md](../manuals/USER_MANUAL_ADMIN_v1.0.1.md) | Reference document — the primary handout |
| [USER_MANUAL_REVIEWER_v1.0.1.md](../manuals/USER_MANUAL_REVIEWER_v1.0.1.md) | For administrators who also support reviewers |
...
| [SYSTEM_DOCUMENTATION_v1.0.1.md](../system/SYSTEM_DOCUMENTATION_v1.0.1.md) | For IT staff attendees who need the technical baseline |
