...
- [PROJECT_SUMMARY_v2.0.0.md](../../PROJECT_SUMMARY_v2.0.0.md) §4 — the feature list
- [SYSTEM_DOCUMENTATION_v1.0.0.md](../system/SYSTEM_DOCUMENTATION_v1.0.0.md) — architecture and security controls
- The three user manuals in [docs/manuals/](../manuals/)
- [DELIVERABLES_REGISTER_v1.0.0.md](DELIVERABLES_REGISTER_v1.0.0.md) Part B — the feature register
...
| N3 | Hosting and infrastructure fees | Paid by CNU directly. See SOW §10. |
