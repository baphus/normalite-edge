...
- v1.0.1 (2026-08-04): Retargeted cross-references to the current document versions. Added the free-tier hosting position to §12 troubleshooting. **No change to any procedure.**
...
As an Admin you have full Reviewer capability. For complete instructions on building exams and study decks, see [USER_MANUAL_REVIEWER_v1.0.1.md](USER_MANUAL_REVIEWER_v1.0.1.md).
...
Most likely a hosting tier issue, not a code issue. If the backend runs on a free Render tier, it spins down when idle and the first request after a quiet period takes tens of seconds to wake it. **This is unacceptable at the start of a timed exam.** The backend currently runs on Render's **free** tier, so this will happen. Report it if it affects an exam, and see `docs/contract/PROPOSAL_AND_SOW_v1.1.0.md` §10.2 — moving to an always-on tier is a CNU decision with a cost attached, and I will advise on it.
...
3. Report it immediately through the support channel, marked urgent (see [MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md](../contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md) §5).
...
**Defects** — the system not behaving as this manual describes — go through the support channel in [MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md](../contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md) §5. During the two-month support period these are fixed at no charge.
...
| Document | For |
|---|---|
| [USER_MANUAL_REVIEWER_v1.0.1.md](USER_MANUAL_REVIEWER_v1.0.1.md) | Building exams and study decks |
| [USER_MANUAL_REVIEWEE_v1.0.0.md](USER_MANUAL_REVIEWEE_v1.0.0.md) | What students were told — useful when supporting them |
| [SYSTEM_DOCUMENTATION_v1.0.1.md](../system/SYSTEM_DOCUMENTATION_v1.0.1.md) | Technical detail, for IT staff |
| [MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md](../contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.1.md) | Support scope and how to report defects |
