...
For architecture, data model, and security controls, see [docs/system/SYSTEM_DOCUMENTATION_v1.0.2.md](docs/system/SYSTEM_DOCUMENTATION_v1.0.2.md).
...
| Document | Contents |
|---|---|
| [docs/system/SYSTEM_DOCUMENTATION_v1.0.2.md](docs/system/SYSTEM_DOCUMENTATION_v1.0.2.md) | Architecture, data model, API surface, security controls, standards-readiness |
| This document | Feature inventory and current state |
| [docs/contract/PROPOSAL_AND_SOW_v1.1.1.md](docs/contract/PROPOSAL_AND_SOW_v1.1.1.md) | Contract of Service proposal and statement of work |
| [docs/contract/DELIVERABLES_REGISTER_v1.1.1.md](docs/contract/DELIVERABLES_REGISTER_v1.1.1.md) | Itemised deliverables with acceptance evidence |
| [docs/contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.2.md](docs/contract/MAINTENANCE_AND_SUPPORT_TERMS_v1.0.2.md) | Two-month defect-support terms |
| [docs/contract/ADMIN_ORIENTATION_PLAN_v1.0.2.md](docs/contract/ADMIN_ORIENTATION_PLAN_v1.0.2.md) | Administrator orientation programme |
| [docs/manuals/USER_MANUAL_ADMIN_v1.0.2.md](docs/manuals/USER_MANUAL_ADMIN_v1.0.2.md) | Administrator manual |
| [docs/manuals/USER_MANUAL_REVIEWER_v1.0.2.md](docs/manuals/USER_MANUAL_REVIEWER_v1.0.2.md) | Reviewer/instructor manual |
